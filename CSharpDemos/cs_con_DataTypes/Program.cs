...
namespace cs_con_DataTypes
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Current Date {0}", dt.ToString("dd-MMM-yyyy"));
            Console.WriteLine("Current Date {0:dd-MMM-yyyy}", dt);
            Console.WriteLine();
            ...
            MyStructure2 objStruct2a;
            objStruct2a.ID = 50;

            MyStructure2 objStruct2b = new MyStructure2();
            objStruct2b.ID = 50;

            MyStructure2 objStruct2c = new MyStructure2(5, "hello");
            objStruct2c.CompanyName = "Microsoft";
