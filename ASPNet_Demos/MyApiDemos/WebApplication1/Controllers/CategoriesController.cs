...
namespace WebApplication1.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        public CategoriesController(
            ApplicationDbContext context, ILogger<CategoriesController> logger)
        {
            _context = context;
            _logger = logger;   
        }
        ...
        public async Task<IActionResult> PostCategory(Category category)
        {
            ...
            try
            {
                ...
                if (countAffected > 0)
                {
                    ...
                    // NOTE: To return the HTTP RESPONSE CODE 201 "Created"
                    // Uri url;
        ...
        // DELETE: api/Categories/5                     !---- Changed
        [HttpDelete("{id}")]
