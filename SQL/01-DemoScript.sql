...
DROP DATABASE [WonderBotzDemo]				--- Drop the GUI created database
GO

CREATE DATABASE [WonderBotzDemo]
GO
...
SELECT * FROM [WonderBotzDemo].[dbo].[Customer1]
...
INSERT INTO [Customers3]
	( [Id], [Name], [Address] )
VALUES
	( 2, 'Second Customer', 'address of the Second customer' ) -- try with duplicate id
GO
SELECT * FROM [Customers3]
GO
...
INSERT INTO [Customers3]
	( [Id], [Name], [Address], [Country] )
VALUES
	( 6, 'Sixth Customer', 'address of the Fifth customer', 'germany' )
GO
...
PRINT @var2
-- PRINT @var1, @var2
PRINT cast(@var1 as varchar(3)) + ', ' + cast( @var2 as varchar(3) )
GO
...
SELECT * FROM [Customers3]
SELECT @@ROWCOUNT AS [NumberOfRecordsAffected]	 -- result of its previous statement == 4
