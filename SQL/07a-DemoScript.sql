 ...
 ******************************************************/
 ...
 SELECT * FROM [VW_Customers] WHERE [Country] = 'France' ORDER BY [CompanyName] DESC
 GO
 ...
 *  Check out Programmability -> Functions -> Scalar-valued Functions
 *********************************/
 ...
 SELECT *, 
		[dbo].[funcScalar]( [Quantity], [UnitPrice] ) AS [COST]
