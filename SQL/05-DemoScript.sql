 ...
 ******************************************************/
 ...
 SELECT GETDATE() AS dtGetDate
		, CONVERT( varchar(20), GETDATE()) AS DefaultConverted
 ...
 ******************************************************/
 ...
 SELECT FORMAT( getdate(), 'dd-MM-yyyy' ) AS fld1
 ...
 DECLARE @d datetime = '2020-03-24'					-- implicitly converted to a datetime variable
 ...
 SELECT FORMAT( 12785.75, '########' ) AS fld1
		, FORMAT( 12785.75, '0000000000.000000' ) AS fld1b
        , FORMAT( 86712785.75, '##,##,##0.0000' ) AS fld2
        , FORMAT( 86712785.75, '##,##,##0.0000', 'en-IN' ) AS fld2b
        , FORMAT( 12785.75, 'US$ ###,##0.00' ) AS fld3
        , FORMAT( 12785.75, 'AU$ ##,##,##0.000000' ) AS fld4
 GO


 SELECT FORMAT( 9+3, REPLICATE('0', 5) )		-- SELECT FORMAT( 12, '00000' )
 GO
 ...
 ******************************************************/
 ...
 -- implicitly typecasted the "string" to a "uniqueidentifier"
